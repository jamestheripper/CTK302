...
function draw() {
  ...
  background('lightgreen'); // light blue
  ...
  textSize(100);
  textAlign(CENTER);
  text("flying high", width / 2, 600, windowWidth - 200, windowHeight - 200);
...
function Car() {
  ...
  this.display = function() {
    ...
    image(birdImage,this.pos.x, this.pos.y, 50,50);
